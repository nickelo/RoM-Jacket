...
:injecFM7s
"%GBC%\fart.exe" "*.bat" [DSK1] "%FM7DSK%"
if "%FM7DSK2%"=="" "%GBC%\fart.exe" "*.bat" --remove [DSK2]
if "%FM7DSK3%"=="" "%GBC%\fart.exe" "*.bat" --remove [DSK3]
if "%FM7DSK4%"=="" "%GBC%\fart.exe" "*.bat" --remove [DSK4]
if "%FM7DSK2%" NEQ "" "%GBC%\fart.exe" "*.bat" [DSK2] "%FM7DSK2%"
if "%FM7DSK3%" NEQ "" "%GBC%\fart.exe" "*.bat" [DSK3] "%FM7DSK3%"
if "%FM7DSK4%" NEQ "" "%GBC%\fart.exe" "*.bat" [DSK4] "%FM7DSK4%"
