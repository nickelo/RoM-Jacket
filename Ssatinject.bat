...
:inject
pushd "%GBG%\%GAM%\%CONS%\%SSAT%\%CSTM%"
"%GBC%\fart.exe" "%SSF%.ini" [ROMPTH] "%GBG%\%GAM%\%CONS%\%SSAT%\%CSTM%"
"%GBC%\fart.exe" "%SSF%.ini" [AREACODE] "%SATREG%"
"%GBC%\fart.exe" "Setting.ini" [AREACODE] "%SATREG%"
popd