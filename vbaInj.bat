...
"%GBC%\fart.exe" "vbam.ini" [PLUG] --remove
"%GBC%\fart.exe" "vbam.ini" [BUF] 0
"%GBC%\fart.exe" "vbam.ini" [CHT] 0
"%GBC%\fart.exe" "vbam.ini" [FILT] 0
"%GBC%\fart.exe" "vbam.ini" [VSYNC] 0
"%GBC%\fart.exe" "vbam.ini" [REZX] %DREZX%
"%GBC%\fart.exe" "vbam.ini" [REZY] %DREZY%
exit /b
...
"%GBC%\fart.exe" "vbam.ini" [REZX] %REZX%
"%GBC%\fart.exe" "vbam.ini" [REZY] %REZY%
